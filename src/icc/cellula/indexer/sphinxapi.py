...
class SphinxClient:
    def __init__ (self):
        ...
        self._error         = b''                           # last error message
        self._warning       = b''                           # last warning message
    ...
    def SetLimits (self, offset, limit, maxmatches=0, cutoff=0):
        ...
        """
        assert ( type(offset) == int and 0<=offset<16777216 )
        assert ( type(limit) == int and 0<limit<16777216 )
        assert(maxmatches>=0)
        self._offset = offset
        self._limit = limit
        if maxmatches>0:
    ...
    def SetRankingMode ( self, ranker, rankexpr=b'' ):
        """
        Set ranking mode.
        """
    ...
    def SetSortMode ( self, mode, clause=b'' ):
        """
        Set sorting mode.
        """
    ...
    def Query (self, query, index='*', comment=b''):
        """
